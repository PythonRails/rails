...
- [+] **Simplify project structure** compared to Django. Sometimes we don't know in what app we need to create new ORM model. With flat project structure we can create model in one `models` folder and save the time. The same for project controllers.
